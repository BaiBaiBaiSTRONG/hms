...
@WebServlet(name="Buildingupdateapi",urlPatterns = "/Buildingupdateapi")
public class Buildingupdateapi extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int result = way.buildingupdate(building,updatetype,updatecontent);
