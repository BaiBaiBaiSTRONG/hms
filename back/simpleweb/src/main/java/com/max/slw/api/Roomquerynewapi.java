...
@WebServlet(name = "roomquerynewapi",urlPatterns = "/roomquerynewapi")
public class Roomquerynewapi extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException{
        ...
        try {
            ...
            list = way.roomquery(tabletype,querytype,querycontent);
