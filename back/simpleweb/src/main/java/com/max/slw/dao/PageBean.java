package com.max.slw.dao;
  ...
  //get、set方法。
            ...
            public PageBean<Entity> findalluserwithpage(int pageNum,int pageSize){
                System.out.println(pageNum);
                System.out.println(pageSize);
                   FunctionsforProgramme way=new FunctionsforProgramme();
                   List<Entity> alluser=null;
                alluser = way.findAllUser();
                int totalRecord = alluser.size();
                   PageBean pb = new PageBean(pageNum,pageSize,totalRecord);
                   int startIndex = pb.getStartIndex();
                   pb.setList(way.findAll(startIndex,pageSize));
                   return pb;
            }
